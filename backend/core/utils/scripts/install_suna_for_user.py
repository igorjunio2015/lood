...
"""
<<<<<<< HEAD
Lood Agent Installation Script for Individual Users

Simple script to install Lood agents for users by email address or account ID.

Usage:
    # Install Lood for a user by email
    python install_suna_for_user.py user@example.com
    
    # Install Lood for a user by account ID
=======
...
<<<<<<< HEAD
from core.utils.suna_default_agent_service import LoodDefaultAgentService
=======
...
<<<<<<< HEAD
class LoodUserInstaller:
    def __init__(self):
        self.db = DBConnection()
        self.service = LoodDefaultAgentService(self.db)
=======
...
>>>>>>> origin/main
        ...
        if agent_id:
<<<<<<< HEAD
            print(f"✅ Successfully installed Lood agent!")
=======
...
<<<<<<< HEAD
            print(f"❌ Failed to install Lood agent for {email}")
    
    async def install_for_account_id(self, account_id: str, replace: bool = False):
        print(f"🚀 Installing Lood agent for account: {account_id}")
=======
...
<<<<<<< HEAD
                ...
                print(f"❌ Failed to install Lood agent for account {account_id}")
=======
                print(f"✅ Successfully installed Suna agent!")
                print(f"   🤖 Agent ID: {agent_id}")
                print(f"   📦 Account: {account_id}")
...
<<<<<<< HEAD
        description="Install Lood agent for a user by email or account ID",
=======
...
<<<<<<< HEAD
                       help='Replace existing Lood agent if present')
=======
