...
<<<<<<< HEAD
# Lood default configuration - simplified and centralized
SUNA_CONFIG = {
    "name": "Lood",
    "description": "Lood is your AI assistant with access to various tools and integrations to help you with tasks across domains.",
=======
